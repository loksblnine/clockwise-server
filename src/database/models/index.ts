...
Master.belongsToMany(City, {through: CityToMaster, as: "city", foreignKey: "city_id"});
City.belongsToMany(Master, {through: CityToMaster, as: "master", foreignKey: "master_id"});
