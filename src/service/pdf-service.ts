import {Customer, Master, Order, Type} from "../database/models";

const PDFDocument = require('pdfkit');
const QRCode = require('qrcode')
export const buildPDF = async (id: number, dataCallback: any, endCallback: any) => {
    ...
    if (order) {
        ...
        doc
            ...
            .fontSize(12)
            .text(
                `${order['master.master_name']}`, 100, 100
            )
        doc
            .font("build/fonts/tnr-b.ttf")
            .fontSize(12)
        ...
        doc
            ...
            .fontSize(12)
            .text(
                `${order['customer.customer_name']}`, 125, 130
            )
        doc
            .font("build/fonts/tnr-b.ttf")
            .fontSize(12)
        ...
        doc
            ...
            .fontSize(12)
            .text(
                `${order['customer.customer_email']}`, 310, 130
            )
        doc
            .font("build/fonts/tnr-b.ttf")
            .fontSize(12)
        ...
        doc
            ...
            .fontSize(12)
            .text(
                `${order['work.description']}`, 125, 160
            )
        doc
            .font("build/fonts/tnr-b.ttf")
            .fontSize(12)
            .text(
                `Дата выполнения заказа: `, 50, 190
            )
        doc
            .font("build/fonts/tnr.ttf")
            .fontSize(12)
            .text(
                `${order.order_time.toLocaleString()}`, 200, 190
            )
        doc
            .font("build/fonts/tnr-b.ttf")
            .fontSize(12)
